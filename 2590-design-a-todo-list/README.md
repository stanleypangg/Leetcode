<h2><a href="https://leetcode.com/problems/design-a-todo-list">2688. Design a Todo List</a></h2><h3>Medium</h3><hr><p>Design a Todo List Where users can add <strong>tasks</strong>, mark them as <strong>complete</strong>, or get a list of pending tasks. Users can also add <strong>tags</strong> to tasks and can filter the tasks by certain tags.</p>
